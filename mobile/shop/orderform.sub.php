...
<div id="sod_approval_frm">
    ...
    <div class="sod_ta_wr">
        <dl id="m_sod_bsk_tot">
            ...
            <?if($coin_use == 1){?>
                ( <?php echo number_format($tot_sell_price / $exchange_rate); ?> <?= $token_symbol ?> )
            <?}?>
            </strong></dd>
            ...
            <dd class="sod_bsk_dvr"><strong><?php echo number_format($send_cost); ?> 
            <?if($coin_use == 1){?><?= $token_symbol ?><?}?></strong></dd>
            ...
            <dd class="sod_bsk_cnt">
                ...
                <?if($coin_use == 1){?>
                (<strong id="ct_tot_price"><?php echo number_format($tot_price / $exchange_rate); ?></strong> <?= $token_symbol ?> )
                <?}?>
        </dl>
    </div>
                ...
                <table>
                    <tbody>
                        ...
                        <tr>
                            <th>내 잔고</th>
                            <td>
                                <?if($coin_use == 1){?><div class="token_balance" style="font-size:13px;font-weight:bold;"></div><?}else{?>
                                    0 원
                                <?}?>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <th>총 주문금액</th>
                            <td><span id="od_tot_price"><?php echo number_format($tot_price); ?></span>원 
                            <?if($coin_use == 1){?>
                                <span id="od_tot_price">( <?php echo number_format($tot_price / $exchange_rate); ?></span> <?= $token_symbol ?> )
                            <?}?>
                            </td>
                        </tr>
                        <tr>
