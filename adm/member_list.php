...
<select name="sfl" id="sfl">
    ...
    <option value="erc20w"<?php echo get_selected($sfl, "erc20w"); ?>>지갑주소</option>
...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr>
        ...
        <th scope="col" id="mb_list_adress" style='' >배송지주소</a></th>
        ...
        <th scope="col" id="mb_list_mobile" style='width:80px;'>휴대폰</th>
        <th scope="col" id="mb_list_lastcall" style='width:80px;'><?php echo subject_sort_link('mb_today_login', '', 'desc') ?>최종접속</a></th>
        <th scope="col" id="mb_list_auth" style="width:50px;">상태</th>
    ...
    <tr>
        ...
        <th scope="col" id="mb_list_wallet" >지갑주소</a></th>
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <?
            //주문주소
            $order_address_result = sql_fetch("SELECT * from g5_shop_order_address WHERE mb_id = '{$mb_id}' limit 0,1 ");
            $order_address = $order_address_result['ad_addr1']." ".$order_address_result['ad_addr2']." ".$order_address_result['ad_addr3'];
        ?>
        <td headers="mb_list_mobile" class="td_tel"><?=$order_address?></td>
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td headers="mb_list_mobile" class="td_tel"><?php echo get_text($row['erc20w']); ?></td>
