...
<div class="local_desc02 local_desc content-box-desc-white">
    ...
    echo $list_tag_end;
    echo '<div class="local_desc01 local_desc content-box-white"><p class="success_text">완료됨</p><p><strong>세션데이터 '.$cnt.'건 삭제 완료됐습니다.</strong><br>프로그램의 실행을 끝마치셔도 좋습니다.</p></div>'.PHP_EOL;
?>
