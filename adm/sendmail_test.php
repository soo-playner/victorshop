...
<section class="content-box">
    <h2>테스트 메일 발송</h2>
    <div class="local_desc02 local_desc content-box-desc-gray">
        <p>
    ...
    <fieldset id="fsendmailtest">
        ...
        <input type="text" name="email" value="<?php echo $member['mb_email'] ?>" id="email" required class="email frm_input" size="80">
        <input type="submit" value="발송" class="btn btn_submit">
    </fieldset>
    </form>
    <div class="local_desc02 local_desc content-box-desc-gray">
        <p>
